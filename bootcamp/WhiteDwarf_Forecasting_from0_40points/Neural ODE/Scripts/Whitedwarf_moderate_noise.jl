...
result_neuralode2 = Optimization.solve(optprob2, Optim.BFGS(; initial_stepnorm = 0.01);
    callback, allow_f_increases = false, maxiters=300)
...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_40points\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_dataNeuralODEtrainedvstraining_data20points.png")
...
open("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_40points\\Neural ODE\\Trained_parameters\\p_minimized_moderatenoise.txt","w") do f
...
#Trained (predicted) DATA up to the 40 elements with the Neural ODE.
...
#It is corrected 
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_40points\\Neural ODE\\Results\\ModerateNoise\\WhitedwarfNODEpredictionvspredictedtrainingdata.png")
...
#
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_40points\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_NODE_forecastedvsGroundTruthDataNoisy_ODE.png")
...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_40points\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_NODE_forecastedvsGroundTruthDataNoNoise_ODE.png")     


#Final plot for the results- better formated
scatter(sol.t[1:end-60],Array(x1_noise[:,1:end-60])[1,:],markershape=:cross,color=:blue, linewidth = 1, xaxis = "\\eta",
     label = "Training \\phi ", title="White Dwarf model")

scatter!(sol.t[1:end-60],Array(x1_noise[:,1:end-60])[2,:],color=:blue,markershape=:cross, linewidth = 1, xaxis = "\\eta",
     label = "Training \\phi'")
xlabel!("\\eta (dimensionless radius)")
...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_40points\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_forecasted_model.png")

#Actual final plot for the preprint
...
plot!(collect(etasteps), prediction[1, :],color=:blue,markeralpha=0.3; label = "Predicted \\phi")
xlabel!("\\eta (dimensionless radius)")

plot!(sol.t[end-60:end],_sol_node[1,end-60:end],color=:red,markeralpha=0.30,label="Forecasted \\phi")
title!("Trained Neural ODE")
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_40points\\Neural ODE\\Results\\ModerateNoise\\NeuralODEModel_finalversion.png")
