...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_dataNeuralODEtrainedvstraining_data90points.png")
...
open("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0\\Neural ODE\\Trained_parameters\\p_minimized_moderatenoise.txt","w") do f
...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_NODE_forecastedvsGroundTruthDataNoisy_ODE.png")
...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_NODE_forecastedvsGroundTruthDataNoNoise_ODE.png")     


#Final plot for the results- better formated
scatter(sol.t[1:end-10],Array(x1_noise[:,1:end-10])[1,:],markershape=:cross,color=:blue, linewidth = 1, xaxis = "\\eta",
...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_forecasted_model.png")
...
plot!(sol.t[1:end-10],prediction[1, :],color=:blue,markeralpha=0.3; label = "Predicted \\phi")
xlabel!("\\eta (dimensionless radius)")

plot!(sol.t[end-10:end],_sol_node[1,end-10:end],color=:red,markeralpha=0.30,label="Forecasted \\phi")
title!("Trained Neural ODE")
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0\\Neural ODE\\Results\\ModerateNoise\\NeuralODEModel_finalversion.png")
