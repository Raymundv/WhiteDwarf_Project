...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_dataNeuralODEtrainedvstraining_data20points.png")
...
open("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Trained_parameters\\p_minimized_moderatenoise.txt","w") do f
...
#Trained (predicted) DATA up to the 10 elements with the Neural ODE.
...
#It is corrected 
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\ModerateNoise\\WhitedwarfNODEpredictionvspredictedtrainingdata.png")
...
#
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_NODE_forecastedvsGroundTruthDataNoisy_ODE.png")
...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_NODE_forecastedvsGroundTruthDataNoNoise_ODE.png")     


#Final plot for the results- better formated
scatter(sol.t[1:end-90],Array(x1_noise[:,1:end-90])[1,:],markershape=:cross,color=:blue, linewidth = 1, xaxis = "\\eta",
     label = "Training \\phi ", title="White Dwarf model")

scatter!(sol.t[1:end-89],Array(x1_noise[:,1:end-89])[2,:],color=:blue,markershape=:cross, linewidth = 1, xaxis = "\\eta",
     label = "Training \\phi'")
xlabel!("\\eta (dimensionless radius)")
...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\ModerateNoise\\Whitedwarf_forecasted_model.png")
...
title!("Trained Neural ODE")
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\ModerateNoise\\NeuralODEModel_finalversion.png")
