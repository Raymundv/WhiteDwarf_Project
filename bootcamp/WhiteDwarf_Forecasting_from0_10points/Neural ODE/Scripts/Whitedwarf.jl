...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\NoNoise\\Whitedwarf_TrainedNeuralODEvstrainingdata.png")



#Saving the trained parameters
open("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Trained_parameters\\p_minimized_nonoise.txt","w") do f
...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\NoNoise\\Whitedwarf_NODEpredictionvspredictedtrainingdata.png")
...
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\NoNoise\\Whitedwarf_no_noise_NODEvsGroundTruthData_ODE.png")

#Final plot for the results- better formated No noise data as test data.
plot(sol.t[1:end-90],Array(sol[:,1:end-90])[1,:],color=:blue, linewidth = 1, xaxis = "\\eta",
     label = "Training \\phi ", title="White Dwarf model")

plot!(sol.t[1:end-90],Array(sol[:,1:end-90])[2,:],color=:blue, linestyle=:dash,linewidth = 1, xaxis = "\\eta",
     label = "Training \\phi'")
xlabel!("\\eta (dimensionless radius)")
...
scatter!(collect(etasteps), predicted[2, :],color=:blue,markershape=:diamond, markeralpha=0.3;label = "Predicted \\phi'")
scatter!(sol.t[end-89:end],_sol_node[1,end-89:end],color=:orange,markeralpha=0.6,label="Forecasted \\phi")

scatter!(sol.t[end-89:end],_sol_node[2, end-89:end],color=:orange,markershape=:diamond,markeralpha=0.6,label="Forecasted \\phi'")
title!("Trained Neural ODE")

scatter!(etasteps2[11:end], sol[1,11:end],label="Testing \\phi",markershape=:xcross,markeralpha=0.9)
scatter!(etasteps2[11:end], sol[2,11:end], label = "Testing \\phi '",markershape=:cross,markeralpha=0.9, color=:red)




savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\NoNoise\\Whitedwarf_forecasted_model.png")


#results better formated with comparison against noisy data as test data.
...
plot!(sol.t[1:end-90],Array(sol[:,1:end-90])[2,:],color=:blue, linewidth = 1, xaxis = "\\eta",
     label = "Training \\phi'")
xlabel!("\\eta (dimensionless radius)")
...
scatter!(sol.t[end-89:end],Array(sol)[1,end-89:end],color=:black, markershape=:hline,label="ODE \\phi")
title!("Trained Neural ODE")
scatter!(sol.t[end-89:end],Array(sol)[2,end-89:end],color=:black, markershape=:cross,label="ODE \\phi'")
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\NoNoise\\Whitedwarf_forecasted_model_ODEVersion.png")


 #Final real version for the preprint


scatter(sol.t[1:end-90],Array(sol[:,1:end-90])[1,:],color=:blue,markeralpha=0.3, linewidth = 1, xaxis = "\\eta",
     label = "Training \\phi ", title="White Dwarf model")


scatter!(sol.t[end-89:end],Array(sol[:,11:end])[1,:], color=:red,markeralpha=0.3, label = "Testing \\phi")

plot!(collect(etasteps), predicted[1, :],color=:blue,markeralpha=0.3; label = "Predicted \\phi")
xlabel!("\\eta (dimensionless radius)")

plot!(sol.t[end-90:end],_sol_node[1,end-90:end],color=:red,markeralpha=0.30,label="Forecasted \\phi")
title!("Trained Neural ODE")
savefig("C:\\Users\\Raymundoneo\\Documents\\SciML Workshop\\bootcamp\\WhiteDwarf_Forecasting_from0_10points\\Neural ODE\\Results\\NoNoise\\NeuralODEModel_finalversion.png")
